...
BACKGROUND_IMAGE="${PROJECT_DIR}/Resources/TaterTunnelDmgBackground.png"
...
cp "${BACKGROUND_IMAGE}" "${STAGING_DIR}/.background/TaterTunnelDmgBackground.png"
...
tell application "Finder"
  tell disk "${VOLUME_NAME}"
    ...
    set background picture of viewOptions to file ".background:TaterTunnelDmgBackground.png"
    set position of item "Tater Tunnel.app" of container window to {420, 265}
    set position of item "Applications" of container window to {615, 265}
    try
